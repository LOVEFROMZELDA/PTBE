function myFun_sweep(input, output, params)
...
switch category
    case 1  % from left to right, single row
        opposite_direction = 0;
        vertical = 0;
        double_line = 0;
    
    case 2  % from right to left, single row
        opposite_direction = 1;
        vertical = 0;
        double_line = 0;
        
    case 3  % from left to right, double row
        opposite_direction = 0;
        vertical = 0;
        double_line = 1;

    case 4  % from right to left, double row
        opposite_direction = 1;
        vertical = 0;
        double_line = 1;

    case 5  % from down to up, single row
        opposite_direction = 0;
        vertical = 1;
        double_line = 0;
    
    case 6  % from up to down, single row
        opposite_direction = 1;
        vertical = 1;
        double_line = 0;
        
    case 7  % from down to up, double row
        opposite_direction = 0;
        vertical = 1;
        double_line = 1;

    case 8  % from up to down, double row
        opposite_direction = 1;
        vertical = 1;
        double_line = 1;
...
for frame = 1:total_frames
    col = frame*4;
    distance1 = sqrt((x_grid - col).^2 + (y_grid - selected_row).^2);
    distance1 = distance1 * time_per_frame;
    distance2 = sqrt((x_grid - col).^2 + (y_grid - selected_row - delta).^2);
